...
l = legend('Exp. 80 to 90 MCM', 'Exp. 80 to 100 MCM', 'Exp. 80 to 110 MCM', 'Exp. 80 to 120 MCM', 'FontSize', 6);
l.Position = l.Position + [-.25 -.5 0 0.1]

title('Expansion Decisions')
subtitle('Non-Optimized Operations: 80, 90, 100, 110, 120 MCM')
ylabel('Frequency')
ylim([0,1200])
xlim([.5,1.5])
set(gca,'XTick',[])
