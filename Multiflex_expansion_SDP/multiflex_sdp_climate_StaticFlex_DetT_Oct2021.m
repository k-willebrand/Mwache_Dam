%% DOCUMENTATION:
% This is V5 of multiflex_sdp_climate_StaticFlex_DetT.m (date: 10/18/2021)
...
optParam.smallCap = x(2); %60; % MCM
optParam.staticCap = x(3); %100; % static size (MCM), added on 6/16/21

% number of possible flexible expansion capacities above initial small
% storage
optParam.numFlex = x(4); %4

% increment of flexible expansion capacities in MCM
optParam.flexIncr = x(5); %10; % MCM
