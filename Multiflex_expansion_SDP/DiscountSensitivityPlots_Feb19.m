...
newCostModel = 1; % if true, then use a different cost model
...
%             strcat('$',string(round(infra_cost_adaptive.plan(2))),'M')};
    ...
    set(gcf, 'PaperPosition', [0 0 figure_width figure_height]);
     ...
     %% Mean simulated dam and shortage cost breakdown
...
%     figure_height = 15;
    ...
    %% Mean simulated dam and shortage cost breakdown by CLIMATE
